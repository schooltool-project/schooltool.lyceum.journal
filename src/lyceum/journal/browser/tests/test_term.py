...
def doctest_SectionTermGradingColumn():
    """Tests for SectionTermGradingColumn.
        ...
        >>> from lyceum.journal.browser.term import SectionTermGradingColumn
...
def doctest_TermView():
    """Tests for the TermView.
        ...
        >>> from lyceum.journal.browser.term import TermView
        >>> request = TestRequest()
    ...
    Section members and default columns are passed to the formatter:
        ...
        [<lyceum.journal.browser.journal.StudentNumberColumn object at ...>,
         <lyceum.journal.browser.journal.GradeClassColumn object at ...>,
