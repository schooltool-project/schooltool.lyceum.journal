...
def doctest_TermGradingData():
    """Tests for TermGradingData.
        ...
        >>> from lyceum.journal.term import TermGradingData
...
def doctest_getPersonTermGradingData():
    """Tests for getPersonTermGradingData.
        ...
        >>> from lyceum.journal.term import getPersonTermGradingData

        >>> from zope.app.container.btree import BTreeContainer
        >>> term_grade_container = BTreeContainer()
        >>> class STAppStub(dict):
        ...     def __init__(self, context):
        ...         self['lyceum.term_grades'] = term_grade_container
    ...
    created:
        ...
        >>> grading_data
        <lyceum.journal.term.TermGradingData object at ...>
